...
class WeatherSettingsViewNew(ConfigListScreen, Screen):
    ...
    <eLabel backgroundColor="background" font="Regular; 27" position="1085,485" size="140,140" text="Virtal Keyboard = Press OK Button" transparent="1" halign="right" valign="center" zPosition="2" foregroundColor="green" />
    <ePixmap position="50,600" zPosition="3" size="240,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/OAWeather/Images/red.png" transparent="1" alphatest="blend" />
    <ePixmap position="365,600" zPosition="3" size="240,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/OAWeather/Images/green.png" transparent="1" alphatest="blend" />
    <ePixmap position="680,600" zPosition="3" size="240,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/OAWeather/Images/yellow.png" transparent="1" alphatest="blend" />
    <ePixmap position="995,600" zPosition="3" size="240,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/OAWeather/Images/blue.png" transparent="1" alphatest="blend" />
    <widget source="key_red" render="Label" position="20,580" zPosition="5" size="300,50" font="Regular;27" halign="center" valign="center" backgroundColor="#313040" foregroundColor="white" transparent="1" />
    <widget source="key_green" render="Label" position="335,580" zPosition="5" size="300,50" font="Regular;27" halign="center" valign="center" backgroundColor="#313040" foregroundColor="white" transparent="1" />
    <widget source="key_yellow" render="Label" position="650,580" zPosition="5" size="300,50" font="Regular;27" halign="center" valign="center" backgroundColor="#313040" foregroundColor="white" transparent="1" />
    <widget source="key_blue" render="Label" position="965,580" zPosition="5" size="300,50" font="Regular;27" halign="center" valign="center" backgroundColor="#313040" foregroundColor="white" transparent="1" />
    </screen>
    """
...
class TestScreen(Screen):
    skin = """
    <screen name="TestScreen" position="center,center" size="1280,720" backgroundColor="black" transparent="0">
    <eLabel position="0,0" size="1280,480" backgroundColor="black" transparent="0" zPosition="0" />
    <ePixmap position="50,655" zPosition="3" size="240,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/OAWeather/Images/red.png" transparent="1" alphatest="blend" />
    <ePixmap position="365,655" zPosition="3" size="240,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/OAWeather/Images/green.png" transparent="1" alphatest="blend" />
    <ePixmap position="680,655" zPosition="3" size="240,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/OAWeather/Images/yellow.png" transparent="1" alphatest="blend" />
    <ePixmap position="995,655" zPosition="3" size="240,50" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/OAWeather/Images/blue.png" transparent="1" alphatest="blend" />
    <widget name="meinelist" position="40,20" size="1200,450" font="Regular;30" itemHeight="45" backgroundColor="black" foregroundColor="white" transparent="0" zPosition="3" scrollbarMode="showOnDemand" />
    <widget name="status" font="Regular; 25" position="0,495" size="1280,40" foregroundColor="unff00" backgroundColor="black" transparent="0" zPosition="3" halign="center" valign="center" />
    <widget source="key_red" render="Label" position="20,635" zPosition="5" size="300,50" font="Regular;27" halign="center" valign="center" backgroundColor="#313040" foregroundColor="white" transparent="1" />
    <widget source="key_green" render="Label" position="335,635" zPosition="5" size="300,50" font="Regular;27" halign="center" valign="center" backgroundColor="#313040" foregroundColor="white" transparent="1" />
    <widget source="key_yellow" render="Label" position="650,635" zPosition="5" size="300,50" font="Regular;27" halign="center" valign="center" backgroundColor="#313040" foregroundColor="white" transparent="1" />
    <widget source="key_blue" render="Label" position="965,635" zPosition="5" size="300,50" font="Regular;27" halign="center" valign="center" backgroundColor="#313040" foregroundColor="white" transparent="1" />
    </screen>
    """
